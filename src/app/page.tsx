...
const experiences = [
  { title: "Bird watching", icon: "/icons/binoculars-eye-svgrepo-com.svg", text: "Follow vibrant sunbirds and soaring raptors across quiet open landscapes." },
  { title: "Farm tours", icon: "/icons/tour-pin-tear-svgrepo-com.svg", text: "Meet the animals, taste fresh produce, and slow down into countryside life." },
  { title: "Wildlife spotting", icon: "/icons/deer-svgrepo-com.svg", text: "Join a guided drive or nature walk for close encounters with Magadi's wildlife." },
  { title: "Maa culture", icon: "/icons/star-alt-4-svgrepo-com.svg", text: "Share stories, music, beadwork, and daily life through a respectful cultural exchange." },
  { title: "Shooting range", icon: "/icons/crosshair-svgrepo-com.svg", text: "Test your focus in a safe, controlled setting with guidance from trained instructors." },
  { title: "Nature spa", icon: "/icons/massage-session-svgrepo-com.svg", text: "Reset with restorative treatments surrounded by warm breezes and wide views." },
];
  ...
  return (
    <main className="bg-[#f5f1e9] text-[#24231f]">
      <section className="relative flex min-h-[calc(100vh-64px)] items-end overflow-hidden bg-[#302d25] text-white">
        <img src="/HeroImgTwo.jpg" alt="A star bed beneath the night sky in Kajiado" className="absolute inset-0 h-full w-full object-cover object-center opacity-75" />
